...
- Download [unrealpak](https://github.com/bananaturtlesandwich/Blue-Fire-Modding-Guide/blob/main/Tools/UnrealPak.zip) and drag the mod folder onto UnrealPak-with-compression.exe
![](Images/Pak.png)
